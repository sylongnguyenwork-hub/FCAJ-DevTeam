...
| --- | ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| Mon | Multi-Factor Authentication (MFA) configuration | Successfully configured Multi-Factor Authentication (MFA) for the account environment, strengthening the system security shield.                                                                                                                                                                                                                    | ![MFA](/images/images/worklog/2/mfa.png?width=400px)|
| Tue | IAM permissions & account management            | Ensured Root User safety by disabling active access keys. Managed and allocated permissions for the sub-user account truc-user within the Admin-groups for daily operations in compliance with regulations.                                                                                                                                         | ![IAM](/images/2-Proposal/iam.png?width=400px)|
