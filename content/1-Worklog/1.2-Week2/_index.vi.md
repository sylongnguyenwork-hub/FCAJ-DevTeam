...
| --- | ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| 2   | Cấu hình bảo mật 2 lớp (MFA)             | Thiết lập thành công xác thực đa yếu tố (MFA) cho môi trường tài khoản, tăng cường lá chắn bảo mật hệ thống.                                                                                                                                                                             | <img src="/FCAJ-DevTeam/images/images/mfa.png" alt="IAM" width="400">|
| 3   | Phân quyền và quản lý tài khoản IAM      | Đảm bảo an toàn cho Root User bằng cách tắt các active access key. Thực hiện quản lý, phân quyền cho người dùng phụ truc-user thuộc nhóm Admin-groups để làm việc hằng ngày đúng quy định.                                                                                               | <img src="/FCAJ-DevTeam/images/images/iam.png" alt="IAM" width="400">|
